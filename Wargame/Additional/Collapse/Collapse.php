<?php
namespace Wargame\Additional\Collapse;
use \Wargame\Additional\Collapse\UnitFactory;
...
class Collapse extends \Wargame\ModernLandBattle
{
    ...
    function __construct($data = null, $arg = false, $scenario = false)
    {
        ...
        $crt = new \Wargame\Additional\Collapse\CombatResultsTable(Collapse::GERMAN_FORCE);
        ...
        if ($data) {
            ...
            $this->victory = new \Wargame\Victory("\\Wargame\\Additional\\Collapse\\VictoryCore");
