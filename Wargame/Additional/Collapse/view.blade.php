@include('wargame::ng-global-header',['topCrt'=> $top_crt = new \Wargame\Additional\Collapse\CombatResultsTable(\Wargame\Additional\Collapse\Collapse::GERMAN_FORCE)])
<script src="{{mix("vendor/javascripts/wargame/collapse.js")}}"></script>
@extends('wargame::Medieval.angular-view',['topCrt'=> $top_crt = new \Wargame\Additional\Collapse\CombatResultsTable(\Wargame\Additional\Collapse\Collapse::GERMAN_FORCE)] )
<link rel="stylesheet" type="text/css" href="{{mix('vendor/css/wargame/collapse.css')}}">
</head>
@section('credit')
    @include('wargame::Additional.Collapse.credit')
@endsection
@section('victory')
...
@section('exclusiveRules')
    @include('wargame::Additional.Collapse.exclusiveRules')
@endsection

@section('inner-crt')
    @include('wargame::Additional.Collapse.Collapse-inner-crt', ['topCrt'=> $top_crt = new \Wargame\Additional\Collapse\CombatResultsTable(\Wargame\Additional\Collapse\Collapse::GERMAN_FORCE)])
@endsection
@section('unitRules.unitColors')
    @include('wargame::Additional.Collapse.unitColors')
@endsection

@section('victoryConditions')
    @include('wargame::Additional.Collapse.victoryConditions')
@endsection
...
@section('obc')
    @include('wargame::Additional.Collapse.obc')
@endsection
...
@section('options')
    <div ng-if="options" id="options-pane">
        <div class="cool-header">
            <h2 >Choose 25 or so strength points for free deploy area.</h2>
