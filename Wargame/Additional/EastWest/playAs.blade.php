...
<style>
    body{
        background:url("<?=url("vendor/wargame/Additional/EastWest/images/lossy-page1-1280px-German_troops_in_Russia_-_NARA_-_540156.tif.jpg")?>") #333 no-repeat;
        background-position:center 0;
        background-size:100%;
    }
    @font-face{
        font-family: OctoberGuard;
        src: url('<?=url("vendor/wargame/Additional/EastWest/fonts/octoberguard.ttf");?>');
    }
    @font-face{
        font-family: Ussr;
        src: url('<?=url("vendor/wargame/Additional/EastWest/fonts/Back_In_the_USSR_DL_k.ttf");?>');
    }
    @font-face{
        font-family: Kremlin;
        src: url('<?=url("vendor/wargame/Additional/EastWest/fonts/kremlin.ttf");?>');
    }
    .guard{
        font-family:OctoberGuard;
    }
...
<h2 id='playastitle' style="text-align:center;font-size:90px;"><span class="guard">East Vs West</span></h2>
<div class="clear">&nbsp;</div>
