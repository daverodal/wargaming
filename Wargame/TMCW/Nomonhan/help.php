...
<div class="game-rules">
    ...
    Red is for Rebel. <div class="unit rebel" alt="0" src="<?=url();?>js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204);   position: relative;"><section></section>
        <img src="<?=url();?>js/multiArmor.png" class="counter">
        <div>6 - 8</div>
    </div>
    <p></p>
    Blue if for Loyalist.
    <div class="unit loyalist" alt="0" src="<?=url();?>js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204); position: relative;"><section></section>
        <img class="arrow" src="<?=url();?>js/short-red-arrow-md.png" style="opacity: 0;">
    ...
    This is Armor (tanks).
    <div class="unit rebel" alt="0" src="<?=url();?>js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204);  position: relative;"><section></section>
        <img src="<?=url();?>js/multiArmor.png" class="counter">
        <div>6 - 8</div>
    </div>
    ...
    <div class="clear"></div>
    <div class="unit rebel" alt="0" src="<?=url();?>js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204); float:left;  position: relative;"><section></section>
        <img src="<?=url();?>js/multiArmor.png" class="counter">
        <div><span class="reduced">3 - 8</span></div>
    </div>
    <div class="unit loyalist" alt="0" src="<?=url();?>js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204); float:left; position: relative;"><section></section>
        <img class="arrow" src="<?=url();?>js/short-red-arrow-md.png" style="opacity: 0;">
        <img src="<?=url();?>js/multiMech.png" class="counter">
