...
<script src="{{mix('vendor/javascripts/wargame/lightning.js')}}"></script>

<link rel="stylesheet" type="text/css" href="{{mix('vendor/css/wargame/lightning.css')}}">
</head>
@section('unitRules')
@include ("wargame::TMCW.Lightning.commonUnitsRules")
@endsection
@section('tec')
    @include("wargame::TMCW.Lightning.tec")
@endsection
@section('SOP')
    @include('wargame::TMCW.Lightning.commonSequenceOfPlay')
@endsection
@section('exclusiveRulesWrapper')
@endsection
@section('exclusiveRules')
    @include('wargame::TMCW.Lightning.exclusiveRules')
@endsection
@section('victoryConditions')
    @include('wargame::TMCW.Lightning.victoryConditions')
@endsection
@section('zoc-rules')
    @include('wargame::TMCW.Lightning.zoc-rules')
@endsection
@section('supply-sources')
    @include('wargame::TMCW.Lightning.supply-sources')
@endsection
