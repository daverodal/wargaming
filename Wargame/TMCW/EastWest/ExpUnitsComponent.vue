<template>
    <div class="units-component">
        ...
        <map-symbol :style="{display: unit.isOccupied ? 'none': 'block', zIndex: 1}" v-for="(unit,key) in myghosts" :key="'ghost-hex'+key" :mapsymbol="{x: unit.x - 18, y:unit.y - 16, image: 'WhiteColHex.svg'}"></map-symbol>
    </div>
</template>
