@include('wargame::ng-global-header',['topCrt'=> $top_crt = new \Wargame\TMCW\EastWest\CombatResultsTable(\Wargame\TMCW\EastWest\EastWest::GERMAN_FORCE)])
...
@section('ng-unit-template')
    <div id="@{{unit.id}}"
        ...
        <div ng-style="{background: unit.integrityColor }" ng-class="unit.infoLen" class="unit-numbers">@{{ unit.strength }} @{{ unit.defStrength }}
...
@section('ng-ghost-unit-template')
    ...
    <div class="unit-numbers">@{{ unit.strength }} @{{ unit.defStrength }} @{{ unit.pointsLeft }}</div>
@endsection
...
@section('exclusiveRules')
    @include('wargame::TMCW.EastWest.exclusiveRules')
@endsection

@section('inner-crt')
    @include('wargame::TMCW.EastWest.EastWest-inner-crt', ['topCrt'=> $top_crt = new \Wargame\TMCW\EastWest\CombatResultsTable(\Wargame\TMCW\EastWest\EastWest::GERMAN_FORCE)])
@endsection
@section('unitRules.unitColors')
    @include('wargame::TMCW.EastWest.unitColors')
@endsection

@section('victoryConditions')
    @include('wargame::TMCW.EastWest.victoryConditions')
@endsection
...
@section('obc')
    @include('wargame::TMCW.EastWest.obc')
@endsection
