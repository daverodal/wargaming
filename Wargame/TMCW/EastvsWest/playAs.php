...
<style>
    ...
    body{
        background:url("<?=url("vendor/wargame/tmcw/eastvsWest/images/Destroyed_Patton_Tank_(1965_Indo-Pak_War).jpg")?>") #333 no-repeat;
...
<h2 id='playastitle' style="text-align:center;font-size:70px;"><span>East Vs West!<br></span></h2>
<div class="clear">&nbsp;</div>
