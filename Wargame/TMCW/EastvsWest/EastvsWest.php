<?php
namespace Wargame\TMCW\EastvsWest;
use Wargame\TMCW\EastvsWest\UnitFactory;
use Wargame\MapData;
/**
 *
...
class EastvsWest extends \Wargame\ModernLandBattle
{
    /* a comment */
    ...
    static function getHeader($name, $playerData, $arg = false)
    {
        ...
        @include_once "eastvsWestHeader.php";
    }


    static function getPlayerData($scenario){
        $forceName = ["Neutral Observer", "Indian", "Pakistani"];
...
//            UnitFactory::create("x", PAKISTANI_FORCE, "deployBox", "multiArmor.png", 6, 3, 6, false, STATUS_CAN_DEPLOY, "B", 1, 1, "pakistani", true, "mech", $i+1);
    ...
    function __construct($data = null, $arg = false, $scenario = false)
    {
        ...
        $crt = new \Wargame\TMCW\EastvsWest\CombatResultsTable();
        ...
        if ($data) {
            ...
            $this->victory = new \Wargame\Victory("Wargame\TMCW\EastvsWest\VictoryCore");
