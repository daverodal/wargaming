@include('wargame::export-global-header', ['topCrt'=> new \Wargame\ModernBattles\Bulge\CombatResultsTable(1)])


<script src="{{mix('vendor/javascripts/wargame/bulge.js')}}"></script>

<link rel="stylesheet" type="text/css" href="{{mix('vendor/css/wargame/bulge.css')}}">
</head>
