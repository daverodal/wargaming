...
//            /* Sikh */
//            for ($i = 0; $i < 12; $i++) {
//                UnitFactory::create("infantry-1", self::SIKH_FORCE, "deployBox", "SikhInfBadge.png", $sikhStrength, $sikhStrength, 3, true, STATUS_CAN_DEPLOY, "A", 1, 1, "Sikh", false, 'infantry');
//            }
//            for ($i = 0; $i < 16; $i++) {
...
//            }
//            for ($i = 0; $i < 6; $i++) {
//                UnitFactory::create("infantry-1", self::SIKH_FORCE, "deployBox", "SikhArtBadge.png", 2, 2, 3, true, STATUS_CAN_DEPLOY, "A", 1, 3, "Sikh", false, 'artillery');
//            }
//            for ($i = 0; $i < 2; $i++) {
...
//            }
//            for ($i = 0; $i < 2; $i++) {
//                UnitFactory::create("infantry-1", self::BRITISH_FORCE, "deployBox", "BritArtBadge.png", 5, 5, 2, true, STATUS_CAN_DEPLOY, "B", 1, 4, "British", false, 'artillery');
//            }
//        }
