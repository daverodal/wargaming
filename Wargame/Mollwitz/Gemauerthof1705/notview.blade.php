...
@include('wargame::Mollwitz.Gemauerthof1705.Gemauerthof1705Header')
<style type="text/css">
    <?php
         include_once "Mollwitz/Gemauerthof1705/all.css";
?>
</style>
</head>
<?php
...
@section('victoryConditions')
    @include('wargame::Mollwitz.Gemauerthof1705.victoryConditions')
@endsection
@section('commonRules')
...
@section('exclusiveRules')
    @include('wargame::Mollwitz.Gemauerthof1705.exclusiveRules')
@endsection
@section('obc')
