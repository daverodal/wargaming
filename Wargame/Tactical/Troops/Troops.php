...
use Wargame\Tactical\Troops\UnitFactory;
/**
 *
...
class Troops extends \Wargame\Tactical\TroopersCore
{
    ...
    function __construct($data = null, $arg = false, $scenario = false, $game = false)
    {
        ...
        $crt = new \Wargame\Tactical\Troops\CombatResultsTable();
        $this->combatRules->injectCrt($crt);
        if ($data) {

        } else {

            $this->victory = new \Wargame\Victory("\\Wargame\\Tactical\\Troops\\troopsVictoryCore");
