...
@include('wargame::Mollwitz.Gadebusch1712.Gadebusch1712Header')
<style type="text/css">
    <?php
         include_once "Mollwitz/Gadebusch1712/all.css";
?>
</style>
</head>
<?php
...
@section('victoryConditions')
    @include('wargame::Mollwitz.Gadebusch1712.victoryConditions')
@endsection


@section('exclusiveRules')
    @include('wargame::Mollwitz.Gadebusch1712.exclusiveRules')
@endsection
