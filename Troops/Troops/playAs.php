...
<style>
    ...
    body{
        background:#000;
        background:url("<?=url("js/Types_of_ordnance._British_guns-elevated_position_mobile_mount_at_the_front._Engineer_Division_Ordnance_Department...._-_NARA_-_533676.png")?>") #333 no-repeat;
